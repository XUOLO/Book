...
public class BookCategoryController {
    ...
    public String editBookCategory(HttpSession session, @ModelAttribute("bookCategory") BookCategory bookCategory, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        String nameLogin = (String) session.getAttribute("name");
