...
public class EmployeeController {
    ...
    @PostMapping("/admin/edit-employee/edit")
    public String editEmployee(@ModelAttribute("user") User user, @RequestParam("roles") List<Long> roleIds, HttpSession session, RedirectAttributes redirectAttributes) {
        String nameLogin = (String) session.getAttribute("name");
